...
import { drop, last, range } from 'lodash';
...
describe('Power duration curve', () => {
  test('should decrease linearly for linear power2', () => {
    ...
    expect(new MeanMaxPower(power).Curve).toEqual([160, 150, 140]);
  });

  test('should decrease linearly for linear power', () => {
    const power = [120, 118, 116, 114, 112, 110, 108, 106, 104, 102, 100];
    expect(new MeanMaxPower(power).Curve).toEqual([120, 119, 118, 117, 116, 115, 114, 113, 112, 111, 110]);
  });

  test('should be const for const power', () => {
    const power = [110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110];
    expect(new MeanMaxPower(power).Curve).toEqual([110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110]);
  });
  ...
  test('should interpolate undefined power value lineary', () => {
    ...
    expect(new MeanMaxPower([...metrics]).Curve).toEqual([120, 119, 118, 117, 116, 115, 114, 113, 112, 111, 110]);
  });
